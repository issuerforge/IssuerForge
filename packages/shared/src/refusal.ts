...
/**
 * Таблиця, яку дзеркалить `programs/issuer-forge/src/error.rs`.
 *
 ...
 * що індекси щільні й унікальні, а тест у програмі звіряє, що Rust-перелік дає
 * ті самі числа. Мовчазне розходження тут коштувало б неправильної причини
 * відмови в журналі, тобто неправильної відповіді регулятору.
 */
